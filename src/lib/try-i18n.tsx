...
const en: TryDict = {
  ...
  cliSub: "Install the open-source CLI and give your agent a wallet — pay per call in USDC, 70+ models, tools and trading data. No API keys.",
...
const zh: TryDict = {
  ...
  cliSub: "安装开源 CLI，给你的 agent 一个钱包——按次用 USDC 付费，70+ 模型、工具与行情数据。无需 API key。",
  cliStepInstall: "1. 安装",
  cliStepRun: "2. 运行",
  cliCopy: "复制命令",
  copied: "已复制",
...
const es: TryDict = {
  ...
  cliSub: "Instala la CLI de código abierto y dale una billetera a tu agente — pago por uso en USDC, 70+ modelos, herramientas y datos de mercado. Sin API keys.",
