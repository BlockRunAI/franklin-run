export function MulticaLogo({ className }: { className?: string }) {
  return (
    <span
...
export function ClaudeCodeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 248 248" fill="currentColor" className={className} aria-hidden="true">
      <path d="M52.4285 162.873L98.7844 136.879L99.5485 134.602L98.7844 133.334H96.4921L88.7237 132.862L62.2346 132.391L36.1274 132.117L22.8862 132.302L17.0591 132.862L14.3848 134.033L13.4297 136.119L14.0028 138.587L20.2119 148.893L33.0711 168.509L40.4575 179.765L44.2737 183.935L47.3299 184.122L49.8133 182.569L51.4734 178.399L52.2375 172.231L52.4285 162.873Z" />
    </svg>
  );
}
...
export function OpenCodeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M18 18H6V6H18V18Z" fillOpacity="0.5" />
      <path d="M18 3H6V18H18V3ZM24 24H0V0H24V24Z" fillRule="evenodd" clipRule="evenodd" />
    </svg>
  );
}
