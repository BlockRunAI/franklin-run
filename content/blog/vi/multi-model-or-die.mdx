...
Hầu hết "tier free" trong công cụ AI là trial 5 ngày với thẻ. Tier free của Franklin khác. Dùng **NVIDIA Nemotron và Qwen3 Coder** — thực sự miễn phí ở nguồn:
...
Bạn ở tier free chạy NVIDIA Nemotron và Qwen3 Coder, không thẻ, không đăng ký. Muốn ghim Sonnet cho một task — nạp $5 và dùng `--profile premium`. Provider sập — router fail-over sang kế tiếp.
