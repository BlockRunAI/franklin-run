...
A maioria dos "tiers grátis" em ferramentas de IA é trial de 5 dias com cartão. O grátis do Franklin é diferente. Usa **NVIDIA Nemotron e Qwen3 Coder** — genuinamente grátis na fonte:
...
No tier grátis rodando NVIDIA Nemotron e Qwen3 Coder, sem cartão, sem cadastro. Quer fixar Sonnet para uma tarefa — fundeie $5 e use `--profile premium`. Modelo deriva — troque profil. Provedor caiu — router fail-over para o próximo.
